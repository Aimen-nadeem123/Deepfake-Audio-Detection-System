...
<style>
    ...
    .header-container {
        ...
        border-radius: 20px; margin-bottom: 2rem; gap: 10px; 
    }
    .site-title {
    ...
    .site-description {
        ...
        font-size: 1.1rem; color: #8892b0; text-align: center; max-width: 600px; line-height: 1.4;
    }
    .result-panel {
        background: rgba(100, 255, 218, 0.05); border: 1px solid #64ffda33;
        border-radius: 15px; padding: 20px; margin-top: 10px;
    }
    [data-testid="stVerticalBlock"] > div:has(div.stAudioRecorder) {
...
<div class="header-container">
    ...
    <h1 class="site-title">FAKE FINDER</h1>
    <p class="site-description">
        Our advanced AI-powered system analyzes vocal frequencies and patterns to distinguish between 
        <b>human speech</b> and <b>AI-generated deepfake audio</b>, ensuring authenticity in the digital age.
    </p>
</div>
""", unsafe_allow_html=True)
...
st.markdown("<br><p style='text-align: center; opacity: 0.3;'>FINAL YEAR PROJECT</p>", unsafe_allow_html=True)
